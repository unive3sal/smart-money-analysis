    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-center gap-3">
          <Badge variant="secondary">{connectedCount} connected wallets</Badge>
          <Badge variant="secondary">{vaultCount} vaults</Badge>
          <Badge variant="outline">Polygon + Solana aware</Badge>
          <Badge variant="outline">Vault automation ready</Badge>
        </div>
            ...
            {walletState?.vaults?.length ? (
              <div className="grid gap-2 md:grid-cols-2">
                {walletState.vaults.map((vault) => (
                  <div key={vault.id} className="rounded-lg border bg-background p-3 text-sm">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {providerOptions.map((option) => (
            <div key={option.key} className="rounded-lg border p-4 space-y-3 bg-muted/20">
              <div>
